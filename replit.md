...
## Recent Updates
- **Procedural SVG Generation (Aug 31, 2025)**: Replaced AI-based SVG generation with client-side procedural JavaScript generation. SVGs are now generated deterministically using card colors and prompt content, eliminating API calls for visual elements and ensuring stable, consistent graphics that don't flicker between renders
